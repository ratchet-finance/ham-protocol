...
import "./SPAMDelegate.sol";

contract SPAMDelegator is SPAMTokenInterface, SPAMDelegatorInterface {
    /**
     * @notice Construct a new SPAM
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "SPAMDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"SPAMDelegator:fallback: cannot send value to fallback");
